...
def predict():
    ...
    new_txn['from_account_id'] = new_txn['from_account_id'].astype(int)
    new_txn['to_account_id'] = new_txn['to_account_id'].astype(int)
    ...
    new_txn["amount_z"] = (new_txn["amount"] - new_txn["from_mean"]) / (new_txn["from_std"] + 1e-5)
